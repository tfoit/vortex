  ...
  initializeMockData() {
    ...
    const mockClients = [
      ...
      },
      {
        id: "client_004",
        name: "Yacht Client",
        email: "yacht.client@email.com",
        birthdate: "1980-05-20",
        clientIdentificationNumber: "CIN-YC-2025-001",
        accountNumber: "CH 1050 1111 3459 7110 0",
        accounts: [
          {
            type: "checking",
            accountNumber: "CH 1050 1111 3459 7110 0",
            iban: "CH10 5011 1134 5971 1000 0",
            currency: "CHF",
            balance: 2500000.0,
            status: "active",
          ...
          {
            type: "savings",
            accountNumber: "CH 1050 1111 3459 7110 1",
            iban: "CH10 5011 1134 5971 1010 0",
            currency: "CHF",
            balance: 5000000.0,
            status: "active",
            openedDate: "2020-01-15",
          ...
          {
            type: "investment",
            accountNumber: "CH 1050 1111 3459 7110 2",
            iban: "CH10 5011 1134 5971 1020 0",
            currency: "CHF",
            balance: 15000000.0,
            status: "active",
            openedDate: "2020-01-15",
        ...
        ibans: ["CH10 5011 1134 5971 1000 0", "CH10 5011 1134 5971 1010 0", "CH10 5011 1134 5971 1020 0"],
        riskProfile: "high",
        portfolio: ["yacht", "investment", "luxury_assets"],
        lastContact: "2025-01-11",
        createdAt: "2020-01-15T00:00:00.000Z",
        status: "active",
        notes: "High net worth client interested in yacht financing. Requires structured credit for 2.3 billion CHF yacht purchase.",
        nationality: "Swiss",
        address: {
      ...
      },
      {
        ...
        accountNumber: "CH10501 1113 4597 1100 0",
        accounts: [
          {
            type: "checking",
            accountNumber: "CH10501 1113 4597 1100 0",
            iban: "CH10 5011 1345 9711 0000 0",
            currency: "CHF",
            balance: 3200000.0,
            status: "active",
          ...
          {
            type: "investment",
            accountNumber: "CH10501 1113 4597 1100 1",
            iban: "CH10 5011 1345 9711 0010 0",
            currency: "CHF",
            balance: 25000000.0,
            status: "active",
            openedDate: "2018-03-20",
        ...
        ibans: ["CH10 5011 1345 9711 0000 0", "CH10 5011 1345 9711 0010 0"],
        riskProfile: "high",
        portfolio: ["yacht", "investment", "luxury_assets"],
        lastContact: "2025-01-11",
        createdAt: "2018-03-20T00:00:00.000Z",
        status: "active",
        notes: "Ultra high net worth client from Bern. Interested in yacht purchase requiring 2.3 billion CHF structured credit facility.",
        nationality: "Swiss",
        address: {
